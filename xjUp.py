...
#   PRIMARY KEY (`Id`)
# ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='a站香蕉up表';
...
def getinfor(timeStr):
    ...
    sql="  SELECT *,SUM(playNum) AS allPlayNum FROM %s WHERE video_type LIKE '%游戏%' AND video_uploadtime<'%s' GROUP BY video_type,video_author ORDER BY allPlayNum DESC LIMIT 20"%(baseTable,timeStr)
...
# http://www.acfun.cn/v/ac4568948 9.6
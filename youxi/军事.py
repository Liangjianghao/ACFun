...
baseTable='actable'
tableName='yutangTable'
baseTime='2008-6-1'

# CREATE TABLE `yutangTable` (
...
#   PRIMARY KEY (`Id`)
# ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='a站鱼塘表';
...
def getdace():
    sql = "SELECT *FROM actable where video_type LIKE '%鱼塘%' ORDER BY video_uploadtime"
    cursor.execute(sql)
    connect.commit()
